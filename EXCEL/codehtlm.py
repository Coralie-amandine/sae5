...
fichier=open("C:/Users/amand/Music/Mon projet SAE15/EXCEL/Dumpfile.txt", "r")
...
plt.axis('equal')
plt.savefig("C:/Users/amand/Music/Mon projet SAE15/EXCEL/graphe1.png")
plt.show()
...
plt.savefig("C:/Users/amand/Music/Mon projet SAE15/EXCEL/graphe2.png")
plt.show()
...
<html>
   ...
   <body>
      <h2>Projet SAE 15</h2>
      <p>Sur cette page web, nous vous présentons les informations pertinentes trouvées dans le fichier à traiter.</p>

      <h3>Nombre total des trames échangées</h3>
      <p>%s</p>

      <h3>Drapeaux (Flags)</h3>
      <p>Nombre de flags [P] (PUSH) = %s</p>
      <p>Nombre de flags [S] (SYN) = %s</p>
      <p>Nombre de flag [.] (ACK) = %s</p>

      <br>

      <img src="graphe1.png" alt="Flags Pie Chart">
      ...
      <img src="graphe2.png" alt="Requests and Replies Pie Chart">
      ...
      <p>Consultez mon <a href="https://example.com/portfolio" target="_blank">portfolio</a> pour en savoir plus.</p>
   </body>
</html>
...
with open('C:/Users/amand/Music/Mon projet SAE15/EXCEL/données.csv', 'w', newline='') as fichiercsv:
...
with open('C:/Users/amand/Music/Mon projet SAE15/EXCEL/Stats.csv', 'w', newline='') as fichier2:
...
with open("C:/Users/amand/Music/Mon projet SAE15/EXCEL/data.html","w") as html:
